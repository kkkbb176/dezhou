...
const outDir = 'D:/德州决策/reports/gtopen-validation/known-node-readonly-20260922-round3';
...
const port = 9383;
const payload = JSON.parse(readFileSync('D:/德州决策/reports/gtopen-validation/9max-known-node-v2/production-5173-live-response.json', 'utf8'));
